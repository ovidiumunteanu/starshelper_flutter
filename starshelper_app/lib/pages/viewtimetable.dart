...
class ViewTmTable extends StatefulWidget {
  ViewTmTable({Key key, this.isNewTable, this.tableName, this.TimeTable, this.usedIndex}) : super(key: key);
...
class _ViewTmTableState extends State<ViewTmTable>
  ...
  proceed() {
    gotoPage(context, IndexListPage(timeTable: timetable, combinedIndex: combinedIndex));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.tableName + "  " + curDay),
